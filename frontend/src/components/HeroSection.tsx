...
export default function HeroSection({ setPage }: Props) {
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-indigo-50/40 py-28"
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <motion.div
          ...
          className="absolute left-20 top-10 h-72 w-72 rounded-full bg-indigo-200 opacity-40 blur-3xl"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-10 right-20 h-72 w-72 rounded-full bg-blue-200 opacity-40 blur-3xl"
        />
      </div>
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              className="rounded-xl border border-indigo-600 px-8 py-4 font-medium text-indigo-600 transition-all duration-300 hover:bg-indigo-600 hover:text-white"
            >
              Login
            </button>
          </div>
        ...
        >
          ...
          <div className="mt-8 text-sm text-gray-500">Semester Growth: +15%</div>
        </motion.div>
      </div>
    </section>
  )
